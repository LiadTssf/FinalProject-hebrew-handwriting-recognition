...
| 3-4 | Apr 18-24 | Initial Implementation | • Refine selected approach<br>• Refine website pages<br>• Start writing Introduction (2.1, 2.2) | • Improved model<br>• Website Fix<br>• Introduction draft | Apr 24 |
...
| 3-4 | 18-24 אפריל | יישום ראשוני | • שיפור הגישה הנבחרת<br>• שינוי האתר לפי המודל החדש<br>• התחלת כתיבת ההקדמה | • שיפור המודל<br>• אתר עדכני<br>• טיוטת הקדמה | 24 אפריל |
