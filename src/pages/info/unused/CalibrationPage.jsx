...
const CalibrationPage = () => {
  ...
  // Guest User Information Component
  const GuestCalibrationInfo = () => {
    return (
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="GuestCalibrationInfo bg-white rounded-lg shadow-lg p-8 border border-gray-200"
      >
        <div className="text-center mb-8">
          {/* triangle ! with yellow color icon */}
          ...
          <h2 className="text-2xl font-bold mt-4 text-gray-800">Personal Calibration Requires an Account</h2>
        </div>
        
        <div className="bg-blue-50 p-6 rounded-lg mb-6 border border-blue-100">
          <h3 className="text-xl font-semibold text-blue-800 mb-3">What is Personal Calibration?</h3>
          <p className="text-blue-700 mb-4">
            Personal calibration is a premium feature that enhances our AI's ability to recognize your specific Hebrew handwriting style.
          </p>
          
          <div className="space-y-4">
            <div className="flex">
              <div className="flex-shrink-0 mt-1">
                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-200">
                  <span className="text-sm font-medium">1</span>
                </div>
              </div>
              <p className="ml-3 text-blue-700">You download our calibration sheets that contain Hebrew characters and text</p>
            </div>
            ...
            <div className="flex">
              ...
              <p className="ml-3 text-blue-700">You fill in these sheets with your handwriting and upload them back to our system</p>
            </div>
            ...
            <div className="flex">
              ...
              <p className="ml-3 text-blue-700">Our system trains a personalized model that recognizes your unique handwriting style</p>
            </div>
            ...
            <div className="flex">
              ...
              <p className="ml-3 text-blue-700">Future document uploads will be processed with significantly higher accuracy</p>
            </div>
          </div>
        </div>
        
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800 mb-3">Benefits of Personal Calibration</h3>
          <ul className="space-y-2">
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700">Up to 35% higher recognition accuracy for your handwriting</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700">Better handling of unique character formations and writing habits</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700">Reduced need for manual corrections after processing</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-700">Multiple calibration profiles for different writing styles</span>
            </li>
          </ul>
        </div>
